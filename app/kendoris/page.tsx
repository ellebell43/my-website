      ...
      return (
        <PrimaryPageWrapper>
          ...
          <div className="text-lg">
            ...
            <Link href="/mapper/68952847043ff9cef4865f67" target="_blank">View the map</Link>
            ...
            <section id="polities">
              ...
              <p>The Paradise Pact is a state separated from the UP that consist of 3 systems, each with a paradise (or near-paradise) planet: <Link href="/mapper/68952847043ff9cef4865f67#0201" target="_blank">Horizon (0201)</Link>, <Link href="/mapper/68952847043ff9cef4865f67#0102" target="_blank">Avend (0102)</Link>, and <Link href="/mapper/68952847043ff9cef4865f67#0301" target="_blank">Cassady (0301)</Link>. Being rich in resources with luxurious planets, the people of the Paradise Pact worried that outsiders would come to pillage or claim their planets. So, they joined together and formed a state, renouncing the UP. They focus on trade between each other and protection from outside parties, and have become very untrusting of the outside universe. The distrust has led to major restrictions and regulations on dealing with people from outside the pact.</p>
