...
import { faArrowDown, faBook, faComputer, faGamepad, faKiwiBird, faPalette } from "@fortawesome/free-solid-svg-icons"
...
export default function Page() {
  return (
    <PrimaryPageWrapper>
      ...
      <p className="text-xl my-3">Welcome to my little corner of the internet! I'm just some random transfem girl from PDX with a big interest in technology <FontAwesomeIcon className="inline" width={20} icon={faComputer} /> story telling <FontAwesomeIcon className="inline" width={18} icon={faBook} /> game development <FontAwesomeIcon className="inline" width={20} icon={faGamepad} /> and pixel art <FontAwesomeIcon className="inline" width={20} icon={faPalette} /> This is were you can find links to most of my projects and socials.</p>
      ...
      <div className="flex flex-col gap-8 max-w-[750px] mx-auto">
        <ProjectCard href="/blog" title="Blog" description="Little posts I write to get out my thoughts and show progress on my projects. Currently a WIP" right={true} />
        <ProjectCard href="/gallery" title="Gallery" description="A place to browse my art. Enjoy!" />
